...
| gateway | The membrane surface: show, release <id>, refuse <id>, open, close. A machine is born closed (nothing in or out); open arms the membrane, never a free flow; no pass entry outlives its epoch | Rust only |
